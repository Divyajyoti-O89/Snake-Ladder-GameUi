    ...
    private void populatePosCoordinates(){
        ...
        for (int i = 0; i < SnakeAndLadder.height; i++) {
            for (int j = 0; j < SnakeAndLadder.width; j++) {
                int xCoord=0;
                if(i%2==0) xCoord=j*SnakeAndLadder.tileSize + SnakeAndLadder.tileSize/2;
                else xCoord=SnakeAndLadder.tileSize*SnakeAndLadder.height - (j*SnakeAndLadder.tileSize) - SnakeAndLadder.tileSize/2;

                int yCoord=SnakeAndLadder.tileSize*SnakeAndLadder.height - (i*SnakeAndLadder.tileSize) - SnakeAndLadder.tileSize/2;
